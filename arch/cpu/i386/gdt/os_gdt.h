...
#define OS_GDT_KERNEL_CODE_ENTRY_IDX 0x1
#define OS_GDT_KERNEL_DATA_ENTRY_IDX 0x2
...
extern void OsBuildGdtEntry(U32 gdtIdx, uintptr_t addr, U32 limit, U8 attrType, U8 attrS,
                            U8 attrDpl, U8 attrP, U8 attrAvl, U8 attrL, U8 attrDb, U8 attrG);
