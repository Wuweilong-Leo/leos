...
OS_SEC_GDT_DATA struct OsGdtEntry g_gdt[OS_GDT_ENTRY_MAX_NUM] = {
    ...
    {.limitLowWord = 0xFFFF,
     .baseLowWord = 0x0000,
     .baseMidByte = 0x00,
     .attrType = (OS_GDT_ENTRY_ATTR_TYPE_TEXT | OS_GDT_ENTRY_ATTR_TYPE_TEXT_NCOR |
    ...
    {.limitLowWord = 0xFFFF,
     .baseLowWord = 0x0000,
     .baseMidByte = 0x00,
     .attrType = (OS_GDT_ENTRY_ATTR_TYPE_DATA | OS_GDT_ENTRY_ATTR_TYPE_DATA_GROW_UP |
...
OS_SEC_KERNEL_TEXT void OsBuildGdtEntry(U32 gdtIdx, uintptr_t addr, U32 limit, U8 attrType,
                                        U8 attrS, U8 attrDpl, U8 attrP, U8 attrAvl, U8 attrL,
                                        U8 attrDb, U8 attrG)
{
...
OS_SEC_KERNEL_TEXT void OsBuildUsrGdtEntry(void)
{
    ...
    OsBuildGdtEntry(OS_GDT_USR_CODE_ENTRY_IDX, 0x0U, 0xFFFFFFFF,
                    ...
                    OS_GDT_ENTRY_ATTR_AVL, OS_GDT_ENTRY_ATTR_L_0, OS_GDT_ENTRY_ATTR_DB_1,
