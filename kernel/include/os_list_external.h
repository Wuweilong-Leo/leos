#ifndef OsList_EXTERNAL_H
#define OsList_EXTERNAL_H
#include "os_def.h"
...
#define OsList_GET_FIRST_NODE(list) ((list)->next)

#define OsList_INIT(list) {(list), (list)}
...
{
    struct OsList *firstNode = OsList_GET_FIRST_NODE(list);
