...
extern void OsDebugPanicSpin(const char *filename, U32 line,
                             const char *func, const char *cond);
extern void OsDebugAssertFail(const char *filename, U32 line,
                               const char *func, const char *cond);

#define OS_PANIC(msg) \
    OsDebugPanicSpin(__FILE__, __LINE__, __func__, (msg))
